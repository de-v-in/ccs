import {
  getTokenMetadataAPI,
  getTokenOpenSeaPricingAPI,
  getTokenTradePriceAPI,
} from "@apis/crawl";
...
> = (item) => {
  ...
  const [lastTradePriceLoading, setLastTradePriceLoading] = useState(false);
  ...
  useEffect(() => {
    ...
    getTokenTradePriceAPI(item.tokenAddress, 1)
      .then((data) => {
        data.length !== 0
          ? setLastTradePrice(data[0].price / 1000000000)
          : null;
      })
      .catch((e) => {})
      .finally(() => setLastTradePriceLoading(false));
  }, [item]);
  ...
  return (
    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      <td className="px-6 py-4">
        ...
        {!lastTradePriceLoading && (lastTradePrice ?? "--")}
      </td>
      <th
        scope="row"
        className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap"
